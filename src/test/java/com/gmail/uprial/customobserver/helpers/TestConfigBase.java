package com.gmail.uprial.customobserver.helpers;

import com.gmail.uprial.customobserver.CustomObserverConfig;
...
public abstract class TestConfigBase {
    ...
    protected static CustomObserverConfig loadConfig(String... contents) throws InvalidConfigurationException, InvalidConfigException {
        return loadConfig(getCustomLogger(), contents);
    }

    protected static CustomObserverConfig loadConfig(TestCustomLogger testCustomLogger, String... contents) throws InvalidConfigurationException, InvalidConfigException {
        return CustomObserverConfig.getFromConfig(getPreparedConfig(contents), testCustomLogger);
    }
